            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-meat-500 focus:border-meat-500 transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    step="0.01"
                    min="0"
                    className="w-full pl-8 pr-4 py-2.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-meat-500 focus:border-meat-500 transition-all"
                    placeholder="0.00"
                    required
                  />
                </div>
