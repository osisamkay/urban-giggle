      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-1">Join ShareSteak</h2>
            <p className="text-gray-500 text-sm">Create your account and start exploring premium meats</p>
          </div>
          ...
          <button type="button" onClick={handleGoogleSignIn} disabled={isLoading} className="group w-full flex items-center justify-center gap-3 px-4 py-2.5 border-2 border-gray-200 rounded-xl shadow-sm bg-white hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-meat-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:shadow-md">
            ...
            <span className="text-sm font-semibold text-gray-700 group-hover:text-gray-900 transition-colors">Sign up with Google</span>
          </button>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="block w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-meat-500 focus:border-meat-500 transition-all hover:border-gray-300"
                  placeholder="John"
                />
              </div>
              <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-11 pr-4 py-2.5 border-2 border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-meat-500 focus:border-meat-500 transition-all hover:border-gray-300"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-11 pr-12 py-2.5 border-2 border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-meat-500 focus:border-meat-500 transition-all hover:border-gray-300"
          ...
          <div className="text-center pt-4 border-t-2 border-gray-100">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="font-bold text-meat-600 hover:text-meat-700 transition-colors hover:underline">Sign in</Link>
            </p>
          </div>
        </div>
