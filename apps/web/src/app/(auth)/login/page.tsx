          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input id="password" name="password" type={showPassword ? 'text' : 'password'} autoComplete="current-password" required value={password} onChange={(e) => setPassword(e.target.value)} className="block w-full pl-11 pr-12 py-2.5 border-2 border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-meat-500 focus:border-meat-500 transition-all hover:border-gray-300" placeholder="Enter your password" />
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <div className="text-sm">
                <Link href="/forgot-password" className="font-semibold text-meat-600 hover:text-meat-700 transition-colors hover:underline">Forgot password?</Link>
              </div>
            </div>
